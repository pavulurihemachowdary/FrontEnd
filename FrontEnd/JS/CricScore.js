...
export class CricScore extends Component {
 ...
 switch (id) {
 case "2":
 this.changeScore(2);this.changeBalls();
 break;
 case "3":
 this.changeScore(3);this.changeBalls();
 break;
 case "4":
 this.changeScore(4);this.changeBalls();
 break;
 case "6":
 this.changeScore(6);this.changeBalls();
 break;
 case "1":
 this.changeScore(1);this.changeBalls();
 break;
 case "No Ball":
